...
- [배포 도메인](b-lab.netlify.app/main/main.html)
...
- [배포 도메인](https://web-portfolio-12fhqa2blnv9fnks.sel5.cloudtype.app/)

### 목표

- vite 기반 react 프로젝트와 typescript 로 컴포넌트를 다룰 수 있다.
- atomic desgin 패턴으로 컴포넌트 구조를 다룬다.
- 전역 상태관리는 recoil 을 활용한다.
- 스타일은 styled-component 를 활용한다.

### 프로젝트 기록

| 레포지토리                                               | 블로그 정리글           |
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [portfolio](https://github.com/Stendhalsynd/portfolio) | [나만의 포트폴리오 제작 회고](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-15%EC%A3%BC%EC%B0%A8-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%ED%9A%8C%EA%B3%A0-%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4)|

### 프로젝트 피그마 디자인

[피그마 디자인 바로보기](https://www.figma.com/file/GOXR9yCZyNVWnbrNttbgHw/%EB%82%98%EB%A7%8C%EC%9D%98-%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4?type=design&node-id=0%3A1&mode=design&t=lXWOr5BDDo4YnNcW-1)
...
| 34 | [useContext 이해하기](https://velog.io/@qmflf556/React-%EC%8A%A4%ED%84%B0%EB%94%94-4%EC%A3%BC%EC%B0%A8-global-state-useContext) | `useContext` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
...
| 39 | [10 ~ 11주차 팀프로젝트 Do-IT 회고1](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-%ED%8C%80%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-Do-IT-%ED%9A%8C%EA%B3%A01) | `slackbot`, `webhook` | ![](https://img.shields.io/static/v1?label=&message=project&color=gray) |
| 40 | [10 ~ 11주차 팀프로젝트 Do-IT 총 회고](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-%ED%8C%80%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-Do-IT-%EC%B4%9D%ED%9A%8C%EA%B3%A0) | `project`, `webhook`, `scss`, `OpenAI`, `slack`, `bolt.js` | ![](https://img.shields.io/static/v1?label=&message=project&color=gray) |
| 41 | [10 ~ 11주차 팀프로젝트 Do-IT 슬랙봇 생성기](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-%ED%8C%80%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-Do-IT-%EC%8A%AC%EB%9E%99%EB%B4%87-%EC%A0%84%EC%B2%B4-%EC%83%9D%EC%84%B1%EA%B3%BC%EC%A0%95) | `slackbot` | ![](https://img.shields.io/static/v1?label=&message=project&color=gray) |
| 42 | [useRef 이해하기](https://velog.io/@qmflf556/React-%EC%8A%A4%ED%84%B0%EB%94%94-6%EC%A3%BC%EC%B0%A8-useRef-%EB%9E%80) | `useRef` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
...
| 44 | [12주차 회고1 atomic design](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-11%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A01-atomic-design) | `atomic design` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
| 45 | [12주차 회고2 this](https://velog.io/@qmflf556/this) | `this` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
...
| 53 | [14주차 회고1 redux toolkit](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-14%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A01-Redux-Toolkit) | `redux-toolkit` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 54 | [15주차 개인 프로젝트 - 나만의 포트폴리오](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-15%EC%A3%BC%EC%B0%A8-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%ED%9A%8C%EA%B3%A0-%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4) | `vite-react`, `recoil`, `typescript`, `atomic design` | ![](https://img.shields.io/static/v1?label=&message=project&color=gray) |
| 55 | [16주차 회고1 Java Arrays & ArrayList method 성능비교](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-16%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A01-Java) | `Arrays`, `ArrayList` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
| 56 | [17주차 회고1 캐스팅 & 인터페이스](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-KDT-Web-8-17%EC%A3%BC%EC%B0%A8-Java-%EC%BA%90%EC%8A%A4%ED%8C%85-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4) | `upcasting`, `downcasting`, `interface` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
| 57 | [18주차 회고1 spring boot](https://velog.io/@qmflf556/spring-boot) | `spring boot` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
| 58 | [18주차 회고2 JDBC](https://velog.io/@qmflf556/%ED%8F%AC%EC%8A%A4%EC%BD%94x%EC%BD%94%EB%94%A9%EC%98%A8-JDBC) | `JDBC` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
| 59 | [19주차 회고1 GraphQL](https://velog.io/@qmflf556/GraphQL-%EA%B3%BC-Apollo) | `GraphQL` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 59 | [19주차 회고2 next.js 입문1](https://velog.io/@qmflf556/next.js-%EC%9E%85%EB%AC%B8) | `Next.js` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 59 | [20주차 회고1 next.js 입문2](https://velog.io/@qmflf556/next.js-%EC%9E%85%EB%AC%B82) | `Next.js` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 60 | [20주차 회고2 Next.js 14 + Styled component](https://velog.io/@qmflf556/nextjs-styled-component) | `Next.js 14`, `styled component` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 61 | [20주차 회고3 Next.js 14 + app router, styled component error](https://velog.io/@qmflf556/Nextjs-app-router-use-styled-component) | `Next.js 14`, `styled component`, `error` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 62 | [21주차 회고1 storybook 자동배포 with chromatic, github actions](https://velog.io/@qmflf556/storybook-%EC%9E%90%EB%8F%99-%EB%B0%B0%ED%8F%AC) | `storybook`, `github action`, `chromatic` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 63 | [21주차 회고2 openvidu 오류모음](https://velog.io/@qmflf556/openvidu-nextjs-cannot-read-properties-of-undefined-reading-document-%EC%98%A4%EB%A5%98) | `openvidu`, `WebRTC` | ![](https://img.shields.io/static/v1?label=&message=study&color=palegreen) |
| 64 | [22주차 회고1 최종 팀 프로젝트 `[커리업]` - WebRTC 기반 1:1 화상 컨설팅 플랫폼 회고](https://velog.io/@qmflf556/openvidu-nextjs-cannot-read-properties-of-undefined-reading-document-%EC%98%A4%EB%A5%98) | `팀 프로젝트`, `WebRTC` | ![](https://img.shields.io/static/v1?label=&message=project&color=gray) |
| 65 | [22주차 회고2 KDT 를 마치며 대기업 취업까지 2023 취준 회고](https://velog.io/@qmflf556/%EC%A0%84%EC%A0%84-%EC%B6%9C%EC%8B%A0-%EC%8B%A0%EC%9E%85-%EA%B0%9C%EB%B0%9C%EC%9E%90-2023%EB%85%84-%EB%8C%80%EA%B8%B0%EC%97%85-%EC%B7%A8%EC%97%85%EA%B9%8C%EC%A7%80-%ED%9A%8C%EA%B3%A0) | `취준회고` | ![](https://img.shields.io/static/v1?label=&message=basic&color=skyblue) |
